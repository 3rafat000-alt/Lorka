...
```bash
python3 company/os/agents/ceo/sofi_scan.py design "<view/feature>" --prj <PRJ> --md   # hardcoded hex, px, !important, missing alt/aria, div-buttons, no reduced-motion, RTL, AI-UI smells
python3 company/os/agents/ceo/sofi_scan.py flow "" --prj <PRJ> --md                    # routes → views map + orphan/dead-end views (UserFlow / UX journey gaps)
```

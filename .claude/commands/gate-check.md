...
---
> **Lead persona:** `gtw-gatekeeper` — the main session *wears* this persona (`.claude/agents/gtw-gatekeeper.md`) or delegates one hop. Flat topology: parallelize with multiple spawns in one message; never nest.

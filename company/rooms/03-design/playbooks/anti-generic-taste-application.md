...
```bash
python3 company/os/agents/uiux/uiux_pipeline.py scan --prj PRJ-XXXX [--query <screen/feature>] --md
python3 company/os/agents/ceo/sofi_scan.py design "<view/feature>" --prj PRJ-XXXX --md
```

...
```bash
python3 company/os/agents/ceo/feature_scan.py "<FEATURE_NAME>" --prj PRJ-XXXX --md
python3 company/os/agents/ceo/sofi_automator.py projects/PRJ-XXXX          # 7-steel-rules scanner; --rule N isolates one, --json for machine output
python3 company/os/agents/ceo/spec_review_preflight.py "<FEATURE_NAME>" --prj PRJ-XXXX  # Phase-1 context bundle
```

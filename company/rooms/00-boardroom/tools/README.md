...
All under `company/os/agents/ceo/` — this directory is effectively the Boardroom's toolbox, ported from v5's `engine/tooling/agents/ceo/` and adapted for the 15-room/105-agent structure:

...
## Future ADRs (Backlog)
- **ADR-011:** Sidecar observability (Sentry → DECISIONS.md feedback loop) — Gate 8 integration
- **ADR-012:** Parallel squad orchestration v2 — Dynamic resource binding + auto-cleanup
- **ADR-013:** Cross-project audit tooling — Automated compliance checks across all PRJ-* repos
